...
namespace ForumDataAccess.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Threads",
                columns: new[] { "Id", "CategoryId", "Created", "ImageUrl", "Title", "UserId" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2019, 9, 26, 15, 20, 15, 296, DateTimeKind.Local), "https://ksassets.timeincuk.net/wp/uploads/sites/54/2019/06/best-free-antivirus-trusted-reviews-920x518.jpg", "Best Free AV", null },
                    { 3, 2, new DateTime(2019, 9, 26, 15, 20, 15, 296, DateTimeKind.Local), "https://ksassets.timeincuk.net/wp/uploads/sites/54/2019/01/Best-FPS-Games-920x613.jpg", "The best FPS game in 2019", null },
                    { 2, 3, new DateTime(2019, 9, 26, 15, 20, 15, 296, DateTimeKind.Local), "https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Firefox_Logo%2C_2017.svg/1200px-Firefox_Logo%2C_2017.svg.png", "New version of FireFox is released", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "The best free antivirus is Kespersky Cloud Free", new DateTime(2019, 9, 26, 15, 20, 15, 296, DateTimeKind.Local), 1, "4d920455-f1e6-4315-a60c-d39de7bfb1a7" },
                    { 2, "Avast is another good free antivirus", new DateTime(2019, 9, 26, 15, 20, 15, 296, DateTimeKind.Local), 1, "af0a7884-8162-4849-8c78-37b9018af963" },
                    { 4, "Call of Duty: Modern Warfare is the best one so far.", new DateTime(2019, 9, 26, 15, 20, 15, 296, DateTimeKind.Local), 3, "af0a7884-8162-4849-8c78-37b9018af963" },
                    { 3, "I hope they've pathed some of the security holes", new DateTime(2019, 9, 26, 15, 20, 15, 296, DateTimeKind.Local), 2, "4d920455-f1e6-4315-a60c-d39de7bfb1a7" }
                });
